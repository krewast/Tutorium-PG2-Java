...
public class Run {
    ...
    public static void main(String[] args) {
        ...
        lstFahrzeug.add(new LKW("NM-TG 790", true, COLOR.RED, 150, 4, 1000));
        lstFahrzeug.add(new LKW("NM-AA 80", true, COLOR.RED, 150, 4, 1000));
        lstFahrzeug.add(new LKW("NM-FF 70", false, COLOR.BLACK, 95, 6, 1500));
        lstFahrzeug.add(new PKW("R-GA 790", true, COLOR.RED, 150, 4, 5));
        lstFahrzeug.add(new PKW("R-AA 80", true, COLOR.RED, 150, 4, 5));
        lstFahrzeug.add(new PKW("R-FF 90", false, COLOR.BLACK, 95, 2, 4));
