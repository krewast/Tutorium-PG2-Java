...
public class PKW extends Fahrzeug {
	...
	public PKW(String kennzeichen, boolean istBenziner,
			COLOR color, int ps, int anzahlTueren, int anzahlSitzplaetze) {
	...
	public String toString() {
		return "PKW [anzahlTueren=" + anzahlTueren + ", anzahlSitzplaetze="
				+ anzahlSitzplaetze + "]" + super.toString();
	}
}
