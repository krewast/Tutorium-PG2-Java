...
public class LKW extends Fahrzeug {
	...
	public LKW(String kennzeichen, boolean istBenziner, COLOR color,
			int ps, int anzahlReifen, int ladeGewicht){
	...
	public String toString() {
		return "LKW [anzahlReifen=" + anzahlReifen + ", ladeGewicht="
				+ ladeGewicht + "]" + super.toString();
	}
}
