...
public class Field {
	...
	/********************************************************************************************
	 * winner check methods from here - not fully implemented, just for demonstration	    *
	 ********************************************************************************************/

	// checks the field for a winner chip using the following methods:
	// checkVertical(), checkHorizontal(), checkDiagonalUp(), checkDiagonalDown()
	...
	// checks each column (vertical) for winner and returns the winning chip or null
	...
	// checks the field for winner by horizontal 4 equal chips and returns the winning Chip or null
	...
	// checks the field for winner by downward diagonal 4 equal chips and returns the winning Chip or null
	...
	// checks the field for winner by upward diagonal 4 equal chips and returns the winning Chip or null
