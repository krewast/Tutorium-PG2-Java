...
public class College {
    ...
    public College(String name) {
        /*
         * #learnmore wonder what 'this' means? 'this' basically means you want
         * to use the 'name' attribute from the class (the private variable in
         * line 16) and not the 'name' variable in this function. With 'this'
         * you make sure that your program knows which attribute you mean.
         */
        this._name = name;
    }
     ...
     * #learnmore
     *
     * alternatively to getAllBaseData and getAllCompleteData, you can write
     * this variable mode (0): base (1): complete
     */
    public String getData(String mode) {
        ...
        for (Student student : this._students) {
             ...
             * #learnmore
             *
             * the operator ?: is the short version of if else, that means: if
             * (mode == "base") { student.getBaseData(); } else {
             * student.getCompleteData(); } is equal to the following statement
             */
            returnData += mode == "base" ? student.getBaseData() : student.getCompleteData();
            returnData += "\n---------\n";
        }
        return returnData;
    }
